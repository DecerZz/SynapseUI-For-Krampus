...
namespace Synapse_UI_WPF.Interfaces
{
    public static class WebInterface
    {
        ...
        public static SynLoginResponse Login(string Username, string Password)
        {
            ...
            return Result.Contains("ERR1") ? new SynLoginResponse(LoginResult.OK, Result.Split('|')[1]) : new SynLoginResponse(Mappings.ContainsKey("") ? Mappings[Result] : LoginResult.UNKNOWN);
        }
